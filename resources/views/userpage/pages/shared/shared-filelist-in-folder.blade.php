                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{-- <form action="{{ route('user.delete-file', $file->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE') --}}
                                            <a class="btn m-0 p-0 text-danger text-decoration-none view-btn" href="#"
                                                data-file-url="{{ asset('uploads/' . $folderName . '/' . $file->file_name) }}"
                                                data-file-type="{{ pathinfo($file->file_name, PATHINFO_EXTENSION) }}">View</a>
                                            &nbsp;&nbsp;&nbsp;
                                            {{-- <button type="submit"
                                                    class="btn m-0 p-0 text-danger text-decoration-none">Delete</button>
                                                &nbsp;&nbsp;&nbsp; --}}
