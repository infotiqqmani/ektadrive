                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h1 class="card-title pb-5 ">
                                {{$folder!=''?$folder->folder_name:'My Drive'}}
                            </h1>
                            
                        </div>
                        <div class="row gap-4">
                            <div style="height: 4rem;" class="col-md-3 stretch-card">
                                <a href="{{ url('teamlead/files/list?id='.@$_GET['id']) }}" class="card filebackground text-decoration-none text-white">
                                    <div class="px-2">
                            ...
                            @foreach ($folders as $folder)
                                <div style="height: 4rem;" class="btn-group rounded col-md-3">
                                    <a href="{{ url('teamlead/my-folders?id=' . $folder->id) }}" class="btn p-2 filebackground">
                                        <span class="text-nowrap text-white d-flex align-items-center mt-2">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="btn p-2" href="{{ url('teamlead/folder/edit/' . $folder->id) }}">Update Folder
                                                Name</a></li>
                                        <li><a class="btn p-2" href="{{ url('teamlead/folder/delete/' . $folder->id) }}">Delete Folder</a>
                                        </li>
        ...
        <div class="modal-dialog">
            <div class="modal-content bg-white">
                ...
                <div class="modal-body">
                    <form action="{{ route('leamlead.folderShare') }}" method="POST" enctype="multipart/form-data">
                        @csrf
