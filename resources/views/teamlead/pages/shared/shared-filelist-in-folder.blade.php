                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif (in_array($file->extension, ['pdf', 'doc', 'docx', 'xls', 'xlsx']))
                                                <a class=" btn m-0 p-0 text-danger text-decoration-none"
                                                    href="{{ asset('storage/' . $folderName . '/' . $file->file_name) }}"
                                                    target="_blank" download>
                                                    Download
                                                </a>
                                            @elseif (in_array($file->extension, ['mp4', 'avi', 'mkv']))
                                                <video width="320" height="240" controls>
                                                    <source class=" btn m-0 p-0 text-danger text-decoration-none"
                                                        src="{{ asset('storage/' . $folderName . '/' . $file->file_name) }}"
                                                        type="video/mp4">
                                                    Your browser does not support the video tag.
                                                </video>
                                            @else
                                                <a href="{{ asset('storage/' . $folderName . '/' . $file->file_name) }}"
                                        ...
                                        <td>
                                            {{-- <form action="{{ route('teamlead.delete-file', $file->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE') --}}
