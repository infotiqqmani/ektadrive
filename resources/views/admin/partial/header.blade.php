            ...
            <li class="nav-item nav-profile dropdown">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown"
                    ...
                    <div class="nav-profile-img">
                        {{-- @if (Auth::check() && Auth::user()->profile_img && Storage::exists('public/profiles/Admin/' . Auth::user()->name . '/' . Auth::user()->profile_img))
                            <img src="{{ asset('storage/profiles/Admin/' . Auth::user()->name . '/' . Auth::user()->profile_img) }}"
