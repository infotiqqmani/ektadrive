                    ...
                    <div class="card-body">
                        <h1 class="card-title">User Profile</h2>
                            <form class="forms-sample" action="{{ route('admin.update') }}" method="post"
                                ...
                                {{-- ===============password========= --}}
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Old Password (optional)</label>
                                    <input type="password" name="old_password" value="" class="form-control"
                                        id="exampleInputEmail1" placeholder="Enter your old Password" />
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">New Password (optional)</label>
                                    <input type="password" name="new_password" value="" class="form-control"
                                        id="exampleInputEmail1" placeholder="Enter your new Password" />
                                </div>
                                ...
                                <a class="btn btn-light" href="{{ route('admin.dashboard') }}">
                                    Cancel
                                </a>
                            </form>
                    </div>
